...
#define SSD1322_HW_CS_Port GPIOA
#define SSD1322_HW_CS_Pin LL_GPIO_PIN_1

#define SSD1322_HW_DC_Port GPIOC
#define SSD1322_HW_DC_Pin	LL_GPIO_PIN_5

#define SSD1322_HW_Res_Port GPIOC
#define SSD1322_HW_Res_Pin	LL_GPIO_PIN_2

#define SSD1322_HW_MISO_Port GPIOA
#define SSD1322_HW_MISO_Pin	LL_GPIO_PIN_6

#define SSD1322_HW_MOSI_Port GPIOA
#define SSD1322_HW_MOSI_Pin	LL_GPIO_PIN_7

#define SSD1322_HW_SCK_Port GPIOA
#define SSD1322_HW_SCK_Pin	LL_GPIO_PIN_5
