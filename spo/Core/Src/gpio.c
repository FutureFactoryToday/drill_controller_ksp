...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOC, LCD_RES_Pin|LCD_DC_Pin);
  ...
  /**/
  LL_GPIO_SetPinMode(KEY2_GPIO_Port, KEY2_Pin, LL_GPIO_MODE_FLOATING);

  /**/
  LL_GPIO_SetPinMode(KEY1_GPIO_Port, KEY1_Pin, LL_GPIO_MODE_FLOATING);
